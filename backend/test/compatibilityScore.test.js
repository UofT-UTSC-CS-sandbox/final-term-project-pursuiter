...
describe("AI Score Feature", () => {
  ...
  it("should fetch the application details with AI scores", async () => {
    ...
    expect(res.body.qualificationsScore).to.have.property("description", "Meets most qualifications");
    expect(res.body.jobDescriptionScore).to.have.property("score", 4);
    expect(res.body.jobDescriptionScore).to.have.property("description", "Matches job description well");
  });
});
