...
describe('Job Management', () => {
  ...
  it('should create a new job', async () => {
    ...
    const job = await mongoose.connection.db.collection('jobs').findOne({ _id: new mongoose.Types.ObjectId(res.body.insertedId) });
  ...
  it('should edit an existing job', async () => {
    ...
    const job = await mongoose.connection.db.collection('jobs').findOne({ _id: new mongoose.Types.ObjectId(jobId) });
    expect(job).to.not.be.null;
